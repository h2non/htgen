...
exports = module.exports = Generator = (function(){
  ...
  prototype.render = function(){
    ...
    } else if (this.node.selfClosed) {
      return this.nodeIndent(
      "<" + this.node.tag + this.renderAttrs() + "/>");
    } else {
      return this.nodeIndent(
...
},{"./doctypes":1,"./helpers":3}],3:[function(_dereq_,module,exports){
...
},{"./generator":2,"./node":5}],5:[function(_dereq_,module,exports){
...
exports = module.exports = Node = (function(){
  ...
  prototype.applyArgs = function(tag){
    ...
    tag)) {
      ref$ = parseTag(
      tag), tagName = ref$.tagName, attributes = ref$.attributes, selfClosed = ref$.selfClosed;
      if (tagName) {
        this.tag = tagName;
      }
      if (selfClosed) {
